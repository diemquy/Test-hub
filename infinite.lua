...
spawn(function() 
    ...
    wait(1.5)
    require(game.ReplicatedStorage.Notification).new("<Color=Red>dsc.gg/infinite<Color=/>"):Display()
    wait(.5)
    require(game.ReplicatedStorage.Notification).new("<Color=Red>ìnifinite Hub Premium!<Color=/>"):Display()
    wait(.14)
    ...
    wait(.29)
    require(game.ReplicatedStorage.Notification).new("<Color=Yellow>Channel : dsc.gg/infite <Color=/>"):Display()
    wait(.36)
end)

local OrionLib = loadstring(game:HttpGet(('https://raw.githubusercontent.com/shlexware/Orion/main/source')))()
local Window = OrionLib:MakeWindow({Name = "infite Hub", HidePremium = false, IntroText = "infinite Library", SaveConfig = true, ConfigFolder = "infinite Hub"})
...
OrionLib:MakeNotification({
	Name = "infinite Hub",
	Content = "infinite Hub Not Skidder, Please don't says",
	Image = "rbxassetid://15992619207",
	Time = 25
})
...
W:AddLabel("Script By mizuhara")

local Section = W:AddSection({
    Name = "Update"
})

W:AddLabel("[+] infinite Hub is back!")
    ...
    while wait() do
        if _G.AutoEliteHunter then
            if game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == true then
                ...
                OrionLib:MakeNotification({
                    Name = "infinite Hub(Noitification)",
                    Content = "[VN] : Hãy hủy nhiệm vụ farrm level(nếu có)",
                    Image = "rbxassetid://15992619207",
                    Time = 9
                })
            end
